...
DROP TABLE IF EXISTS `node_mapping_between_g_cg`;
DROP TABLE IF EXISTS `edge_mapping_between_g_cg`;
...
CREATE TABLE `edge_mapping_between_g_cg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `PID_CG` varchar(256) DEFAULT NULL,
  `Id_CG_e` varchar(256) DEFAULT NULL,
  `PID_G` varchar(256) DEFAULT NULL,
  `Id_G_e` varchar(256) DEFAULT NULL,
  `Part_of_mapping_or_not` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1511 DEFAULT CHARSET=utf8;


CREATE TABLE `node_mapping_between_g_cg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `PID_CG` varchar(256) DEFAULT NULL,
  `Id_CG_n` varchar(256) DEFAULT NULL,
  `PID_G` varchar(256) DEFAULT NULL,
  `Id_G_n` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id`)
