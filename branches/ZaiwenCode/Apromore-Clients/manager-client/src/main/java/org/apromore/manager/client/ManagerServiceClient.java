...
public class ManagerServiceClient implements ManagerService {
    ...
    /**
     * @see ManagerService#importProcess(String, Integer, String, String, String, java.io.InputStream, String, String, String, String, boolean, java.util.Set)
     * {@inheritDoc}
     */
    @Override
    @SuppressWarnings("unchecked")
...
//    }
    ...
    public void updateProcess(final Integer sessionCode, final String username, final String nativeType, final Integer processId,
        ...
        /*the following 'set' code is for change propagation*/
        msg.setPropagationIndex(propagationIndex);  //if 'propagationIndex' is equal to 1, then propagate change; if 0, then do not propagate change

//        msg.setProcessVersionIdOriginalVariant(originalProcessVariant);
//        msg.setProcessVersionIdChangedVariant(changedProcessVariant);
//        msg.setProcessVersionIdOriginalMerged(originalMerged);
//        msg.setTargetedVersionName(targetedVersionName);
//        msg.setTargetedBranchName(targetedBranchName);
        /*the above 'set' code is for change propagation*/
        ...
        /*the following 'get' code is for change propagation*/
        if (response.getValue().getUpdatedResultForPropagatedSide().getCode() == -1){
            throw new Exception(response.getValue().getUpdatedResultForPropagatedSide().getMessage());
        }
        /*the above 'get' code is for change propagation*/
    }
