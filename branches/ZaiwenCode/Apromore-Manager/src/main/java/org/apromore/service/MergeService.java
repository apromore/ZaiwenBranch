...
public interface MergeService {
     ...
     * @throws org.apromore.exception.ExceptionMergeProcess if the merge failed
     */
...
//    /***
//     * Get the identifiers of all the nodes for a process model version.
//     * */
//
//     List<String> getNodesIds (String processModelVersionId);
//
//    /***
//     * Get the identifiers of all the edges for a process model version
//     * */
//
//
//     List<String> getEdgesIds (String processModelVersionId);
}
