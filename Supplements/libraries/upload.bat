...
call mvn install:install-file -Dfile=commons-fileupload-1.2.2.jar -DgroupId=commons-fileupload -DartifactId=commons-fileupload -Dversion=1.2.2 -Dpackaging=jar -DgeneratePom=true
